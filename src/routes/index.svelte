...
<div class="background">
  <div class="content">
    ...
    <p>
      ...
      {days_in_office_every_four_weeks} av {MAX_DAYS_EVERY_FOUR_WEEKS} dager på kontoret.
      <strong>
    ...
    <div class="results">
      ...
      mulige. Av disse var {total_days_in_office} på kontoret, og medførte {Math.round(
        kilometers_traveled
      )}
